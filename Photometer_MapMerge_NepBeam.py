...
#
obsids  = [0x5000241d,0x5000241c,0x5000241b,0x5000241a]
pools   = ['default', 'default','default','default']
...
simpleFitsWriter(psw_combined, outDir+"NepBeam_psw_1arcsec_combined.fits")
simpleFitsWriter(pmw_combined, outDir+"NepBeam_pmw_1arcsec_combined.fits")
simpleFitsWriter(plw_combined, outDir+"NepBeam_plw_1arcsec_combined.fits")
