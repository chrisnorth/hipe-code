...
#  Chris North     - 25/Feb/2014 - 2.8: BUG FIX: Uses KmonE not K4E in calculations
#                                       
#===============================================================================

scriptVersionString = "makeSCalPhotColorCorrHfi.py $Revision: 2.8 $"
...
if inputCalDirTree:
	...
	fluxConvVersion = "2.8"
	fluxConv = fitsReader("%s//Phot//SCalPhotFluxConv//SCalPhotFluxConv_0_v%s.fits"%(directory, fluxConvVersion))
else:
