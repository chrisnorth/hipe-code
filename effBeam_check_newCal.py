...
pbm=PlotXY()
linPsw=LayerXY(beamsIn['radius'],beamsIn['PSW']['Comb'],color=java.awt.Color(0,0,150))
pbm.addLayer(linPsw)
linPmw=LayerXY(beamsIn['radius'],beamsIn['PMW']['Comb'],color=java.awt.Color(0,150,0))
pbm.addLayer(linPmw)
linPlw=LayerXY(beamsIn['radius'],beamsIn['PLW']['Comb'],color=java.awt.Color(150,0,0))
pbm.addLayer(linPlw)
lscPsw=LayerXY(beamsSCal['radius'],beamsSCal['PSW']['Comb'],color=java.awt.Color(0,0,255))
lscPsw.line=Style.DASHED
pbm.addLayer(lscPsw)
lscPmw=LayerXY(beamsSCal['radius'],beamsSCal['PMW']['Comb'],color=java.awt.Color(0,255,0))
lscPmw.line=Style.DASHED
pbm.addLayer(lscPmw)
lscPlw=LayerXY(beamsSCal['radius'],beamsSCal['PLW']['Comb'],color=java.awt.Color(255,0,0))
lscPlw.line=Style.DASHED
pbm.addLayer(lscPlw)

pbmd=PlotXY()
pbmd.addLayer(LayerXY(beamsIn['radius'],beamsIn['PSW']['Comb']-beamsSCal['PSW']['Comb'],color=java.awt.Color(0,0,150)))
pbmd.addLayer(LayerXY(beamsIn['radius'],beamsIn['PMW']['Comb']-beamsSCal['PMW']['Comb'],color=java.awt.Color(0,150,0)))
pbmd.addLayer(LayerXY(beamsIn['radius'],beamsIn['PLW']['Comb']-beamsSCal['PLW']['Comb'],color=java.awt.Color(150,0,0)))

if doArea:
	if doCheck:
		print "Checking..."
		fileUnnorm='/data/Herschel/Calibration/Beam_plots/EffBeams/Unnorm_areas.csv'
		chkArea={'radius':asciiTableReader(file=fileUnnorm, tableType='CSV')['radius'].data[0:maxRad],
			'PSW':asciiTableReader(file=fileUnnorm, tableType='CSV')['PSW'].data[0:maxRad],
			'PMW':asciiTableReader(file=fileUnnorm, tableType='CSV')['PMW'].data[0:maxRad],
			'PLW':asciiTableReader(file=fileUnnorm, tableType='CSV')['PLW'].data[0:maxRad]}

		fileNorm='/data/Herschel/Calibration/Beam_plots/EffBeams/Norm_areas.csv'
