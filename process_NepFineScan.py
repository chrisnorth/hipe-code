...
#***********************************************
## Import modules required for horizons
...
#
myObsids	= [0x5000241a,0x5000241b,0x5000241c,0x5000241d]
nObs=len(myObsids)
myDataPool = "default"
...
for myObsid in myObsids:
	...
	scans_rg=baselineRemovalMedian(level1_rg)
