...
# HFI RIMO file
hfiRIMOFile = '/Users/lconversi/Work/Herschel/HP Cross-Cal/K-Corr/HFI_RIMO_R1.10.fits'

# SPIRE aperture efficiency file
aperEffFile = '/Users/lconversi/Work/Herschel/HP Cross-Cal/K-Corr/SpirePhotApertureEfficiency.fits'
 
# Name of output table
outFilename = '/Users/lconversi/Work/Herschel/HP Cross-Cal/K-Corr/SpireHfiColourCorrTab_v%3.1f.fits'%ver
...
#calibration = SpireCal.getInstance()					# Get SPIRE calibration tree
calibration = spireCal(jarFile='/home/chris/dp_spire/cal/spire_cal_12_0.jar')
...
# Read aperture efficiency table
SpireApEff = fitsReader(file = aperEffFile)
spireApEffFreq = SpireApEff["HDU_1"]["Frequency"].data * 1e12 #comes in [THz]
spireApEffPsw  = SpireApEff["HDU_1"]["PSW"].data
spireApEffPmw  = SpireApEff["HDU_1"]["PMW"].data
spireApEffPlw  = SpireApEff["HDU_1"]["PLW"].data
